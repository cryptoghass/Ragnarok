...
{
    resize(900, 520);
    setWindowTitle(tr("Ragnarok") + " - " + tr("Wallet"));
...
#endif
    setObjectName("ragnarok");
    setStyleSheet("#ragnarok { background-color: #ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    progressBar->setStyleSheet("QProgressBar { background-color: #ffffff; border: 0px solid grey; border-radius: 0px; padding: 3px; text-align: center; } QProgressBar::chunk { background: #d77575; border-radius: 0px; margin: 0px; }");
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #ffffff; background-color: #ffffff; border: 0px solid grey; border-radius: 0px; padding: 0px; text-align: center; } QProgressBar::chunk { background: #d77575; border-radius: 0px; margin: 0px; }");
        }
    }
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #31101F, stop: 1 #CB4D4D);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Ragnarok address"));
    ...
    pioAction = new QAction(tr("&Ragnarok Website"), this);
	pioAction->setToolTip(tr("Visit the Official Ragnarok website"));
    bitcointalkAction = new QAction(tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Ragnarok discussion thread"));
    chainAction = new QAction(tr("&Ragnarok Discord"), this);
    chainAction->setToolTip(tr("Join Ragnarok Discord"));
    explorerAction = new QAction(tr("&Ragnarok Explorer"), this);
	explorerAction->setToolTip(tr("Ragnarok Explorer"));	
    aboutAction = new QAction(tr("&About Ragnarok"), this);
    aboutAction->setToolTip(tr("Show information about Ragnarok"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Ragnarok"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 600; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; margin: 5px; border-radius: 4px; }"
                           "QToolButton:hover { background-color: #CB4D4D; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:checked { background-color: #CB4D4D; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:pressed { background-color: #d77575; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "#tabs { color: #000000; background-color: qradialgradient(cx: -0.2, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #31101F, stop: 1 #F0D6C1); border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Ragnarok client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Ragnarok client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ragnarok network", "", count));
}
...
void BitcoinGUI::gotomktPage()
{
    ...
    QDesktopServices::openUrl(QUrl("https://ragnaproject.io/redirect/marketplace"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Ragnarok address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("https://ragnaproject.io"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://ragnaproject.io/redirect/bitcointalk"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://ragnaproject.io/redirect/discord"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://ragnaproject.io/redirect/explorer"));
}
